...
export const riskData: RiskRow[] = [
  { riskId: 1001, gtin: 1100000000001, mrdr: 50001, mrdrDescription: "Dove Body Wash 250ml", msoCountry: "DE", site: "C402", su: "SU-DE-01", riskType: "Out Of Stock", severity: "S 1", priority: "P 1", riskHorizon: "Short", segmentation: "A", startedOnWeek: "2024-W42", endedOnWeek: "", riskInDays: 14, stockCS: 120, expectedLossCases: 450, expectedLossValue: 34200, nextAvailableDate: "", botReasonCode: "R01", plannerReasonCode: "R01", comments: "Supplier delay confirmed", assignedTo: "Hans Müller", insights: "View More", promoFlag: "Y", typeCode: "Standard", repackDependency: "N", category: "Personal Care", status: "Open", uom: "CS" },
  { riskId: 1002, gtin: 1100000000002, mrdr: 50002, mrdrDescription: "Surf Excel 1L Liquid", msoCountry: "FR", site: "C400", su: "SU-FR-02", riskType: "Below RS", severity: "S 2", priority: "P 1", riskHorizon: "Med", segmentation: "A", startedOnWeek: "2024-W41", endedOnWeek: "", riskInDays: 21, stockCS: 85, expectedLossCases: 320, expectedLossValue: 28900, nextAvailableDate: "2024-11-15", botReasonCode: "R03", plannerReasonCode: "R02", comments: "", assignedTo: "Marie Dubois", insights: "View More", promoFlag: "N", typeCode: "Standard", repackDependency: "N", category: "Home Care", status: "Open", uom: "CS" },
  ...
  { riskId: 1007, gtin: 1100000000007, mrdr: 50007, mrdrDescription: "Vaseline Body Lotion 400ml", msoCountry: "PL", site: "C420", su: "SU-PL-01", riskType: "Out Of Stock", severity: "S 2", priority: "P 2", riskHorizon: "Med", segmentation: "A", startedOnWeek: "2024-W41", endedOnWeek: "", riskInDays: 18, stockCS: 25, expectedLossCases: 560, expectedLossValue: 42000, nextAvailableDate: "", botReasonCode: "R04", plannerReasonCode: "R06", comments: "Escalated to regional lead", assignedTo: "Jan Kowalski", insights: "View More", promoFlag: "N", typeCode: "Standard", repackDependency: "N", category: "Personal Care", status: "Open", uom: "CS" },
  ...
  { riskId: 1011, gtin: 1100000000011, mrdr: 50011, mrdrDescription: "Rexona Deodorant 200ml", msoCountry: "ES", site: "C410", su: "SU-ES-02", riskType: "Out Of Stock", severity: "S 2", priority: "P 1", riskHorizon: "Short", segmentation: "A", startedOnWeek: "2024-W43", endedOnWeek: "", riskInDays: 6, stockCS: 15, expectedLossCases: 780, expectedLossValue: 58500, nextAvailableDate: "", botReasonCode: "R03", plannerReasonCode: "", comments: "Awaiting planner input", assignedTo: "Elena Fernández", insights: "View More", promoFlag: "N", typeCode: "Standard", repackDependency: "N", category: "Personal Care", status: "Open", uom: "EA" },
  ...
  { riskId: 1013, gtin: 1100000000001, mrdr: 50001, mrdrDescription: "Dove Body Wash 250ml", msoCountry: "DE", site: "C402", su: "SU-DE-01", riskType: "Out Of Stock", severity: "S 2", priority: "P 1", riskHorizon: "Med", segmentation: "A", startedOnWeek: "2024-W44", endedOnWeek: "", riskInDays: 10, stockCS: 80, expectedLossCases: 300, expectedLossValue: 22800, nextAvailableDate: "", botReasonCode: "R03", plannerReasonCode: "R02", comments: "Second batch delay", assignedTo: "Hans Müller", insights: "View More", promoFlag: "N", typeCode: "Standard", repackDependency: "N", category: "Personal Care", status: "Open", uom: "CS" },
  { riskId: 1014, gtin: 1100000000003, mrdr: 50003, mrdrDescription: "Lipton Green Tea 50pk", msoCountry: "IT", site: "C405", su: "SU-IT-01", riskType: "Out Of Stock", severity: "S 2", priority: "P 2", riskHorizon: "Med", segmentation: "B", startedOnWeek: "2024-W45", endedOnWeek: "", riskInDays: 5, stockCS: 40, expectedLossCases: 420, expectedLossValue: 32000, nextAvailableDate: "", botReasonCode: "R04", plannerReasonCode: "R03", comments: "Alternate supplier contacted", assignedTo: "Paolo Rossi", insights: "View More", promoFlag: "N", typeCode: "Repack", repackDependency: "Y", category: "Foods", status: "Open", uom: "EA" },
  { riskId: 1015, gtin: 1100000000009, mrdr: 50009, mrdrDescription: "Hellmann's Mayonnaise 400g", msoCountry: "FR", site: "C400", su: "SU-FR-03", riskType: "Out Of Stock", severity: "S 2", priority: "P 2", riskHorizon: "Med", segmentation: "A", startedOnWeek: "2024-W45", endedOnWeek: "", riskInDays: 8, stockCS: 30, expectedLossCases: 950, expectedLossValue: 95000, nextAvailableDate: "", botReasonCode: "R06", plannerReasonCode: "R04", comments: "Supply recovery in progress", assignedTo: "Pierre Dupont", insights: "View More", promoFlag: "Y", typeCode: "Repack", repackDependency: "Y", category: "Foods", status: "Open", uom: "KG", isNew: true },
];
