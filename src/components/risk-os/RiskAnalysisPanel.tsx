        ...
        <div className="flex flex-col border-b border-border shrink-0 bg-card">
          <div className="h-12 flex items-center justify-between px-5">
            <div className="flex items-center gap-3">
              {showLastMile ? (
                <Button variant="ghost" size="icon" className="h-7 w-7 text-foreground hover:bg-secondary" onClick={() => setShowLastMile(false)}>
                  <ArrowLeft className="h-4 w-4" />
                </Button>
              ) : (
                <Button variant="ghost" size="icon" className="h-7 w-7 text-foreground hover:bg-secondary" onClick={onClose}>
                  <ArrowLeft className="h-4 w-4" />
                </Button>
              )}
